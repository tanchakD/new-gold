               ...
               <div class="row ">
                  <div class="col-12 ">
                     <ul class="p-md-3 p-2 bg-light">
                        ...
                        <li class="d-inline-block hr_ font-weight-bolder">profile</li>
                     </ul>
                  </div>
               </div>
            </div>
...
?> 
                                         ...
                                         <input type="text" name="regdate" value="<?php  echo $row['regDate'];?>"  readonly="true" class="form-control">
                                          <br>
                                          <button class="btn btn-primary" type="submit" name="submit" style="background:#D69531">Save Change</button>
                                   </form>
                                   <?php }?>
                                   </div>
			</div>
