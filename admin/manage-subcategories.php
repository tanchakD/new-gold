...
?>  
                                ...
                                <tr>
                                            ...
                                            <td>
                                            <a href="edit-subcategory.php?id=<?php echo $row['subid']?>"><i class="fas fa-edit" style="color:#d69531; font-size:18px;"></i></a> | 
                                            <a href="manage-subcategories.php?id=<?php echo $row['subid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" style="color:red; font-size:18px;" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
