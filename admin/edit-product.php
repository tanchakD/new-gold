...
<div class="col-6"><img src="productimages/<?php echo htmlentities($row['productImage4']);?>" width="250"><br />
    <a href="change-image4.php?id=<?php echo $row['pid'];?>">Change Image</a>
</div>
</div>
