...
?>  
                                ...
                                <tr>
                                            ...
                                            <td>
                                            <a href="edit-category.php?id=<?php echo $row['catid']?>"><i class="fas fa-edit" style="color:#d69531; font-size:18px;"></i></a> | 
                                            <a href="manage-categories.php?id=<?php echo $row['catid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" style="color:red; font-size:18px;" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
