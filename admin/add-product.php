...
$extension4 = substr($productimage4,strlen($productimage4)-4,strlen($productimage4));
...
$imgnewfile4=md5($productimage4.time()).$extension4;
...
$addedby=$_SESSION['aid'];
    ...
    move_uploaded_file($_FILES["productimage4"]["tmp_name"],"productimages/".$imgnewfile4);

$sql=mysqli_query($con,"insert into products(category,subCategory,type,productName,productweight,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productImage4,gender,addedBy) values('$category','$subcat','$type','$productname','$productweight','$productprice','$productdescription','$productscharge','$productavailability','$imgnewfile1','$imgnewfile2','$imgnewfile3','$imgnewfile4','$gender','$addedby')");
...
<div class="row" style="margin-top:1%;">
<div class="col-2">Product Image 4</div>
<div class="col-4"><input type="file" name="productimage4"  class="form-control" accept="image/*" title="Accept images only" required>
</div>
</div>
