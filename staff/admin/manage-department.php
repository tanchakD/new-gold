...
<td><a href="edit-department.php?depid=<?php echo htmlentities($result->id);?>"><span class="btn btn-success">Edit</span></i> | <a href="manage-department.php?del=<?php echo htmlentities($result->id);?>"><span class="btn btn-danger">Delete</span></td>
                  </tr>
                 </tbody>
                 <?php  $cnt=$cnt+1; } } ?>
              </table>
